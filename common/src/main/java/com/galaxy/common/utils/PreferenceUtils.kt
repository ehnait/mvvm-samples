 ...
 *
 * Des: http://kotlinlang.org/docs/reference/delegated-properties.html
 */

class PreferenceUtils<T>(val name: String, private val default: T) {

    companion object {
        private const val FILE_NAME = "galaxy_common_file"

        private val prefs: SharedPreferences by lazy {
            ApplicationUtils.getApplication().applicationContext.getSharedPreferences(
                FILE_NAME,
